---
title: "Comparing Dissmilarity Indices between CBSA and Historical Delineations"
...
```{r Part B: Compile transformed objects}
...
```{Part C: Compute Dissimilarity index}
ncdb_cw <- ncdb_cw %>%
  ungroup() %>%
...
#### E. Visualize differences between measurements

```{r Part E: Visualizations}
